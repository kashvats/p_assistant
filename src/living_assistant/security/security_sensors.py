...
from living_assistant.security.security_guardian import _run, _now, _redact_obj, _redact_text, file_signature, sha256_file
from living_assistant.core.sqlite_utils import ThreadLocalSQLite
from .sensor_shared import _safe_json, _event_time
from .sensors_windows import (
    SYSMON_CHANNEL,
    WINDOWS_SECURITY_CHANNEL,
    HIGH_SIGNAL_SYSMON_IDS,
    normalize_sysmon_event,
    normalize_windows_security_event,
    collect_windows_eventlog,
)
from .sensors_macos import collect_macos_unified_log
