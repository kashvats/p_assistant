...
def run_tray(runtime, dashboard_url: str = 'http://127.0.0.1:8787/dashboard'):
    ...
    nervous = NervousSystem(runtime.config, runtime.memory, runtime.processes, runtime.watches, runtime.notifier,
                            ...
                            briefings=runtime.briefings, sessions=runtime.sessions, guardian=runtime.guardian, security_sensors=runtime.security_sensors, experiences=runtime.experiences, group_controller=runtime.group_controller, connector_manager=runtime.connector_manager, mobile_bridge=runtime.mobile_bridge, peers=runtime.peers)
