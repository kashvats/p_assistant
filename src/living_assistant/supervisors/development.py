...
DEVELOPMENT_PROMPTS = {
    "coding": "You are a senior coding specialist. Propose concrete diffs and minimal necessary edits.",
    "debugging": "You are a debugging specialist. Analyze traces, stack traces, and logs. Provide the root cause.",
    "database": "You are a database specialist. Provide read-only diagnostic SQL queries or analyze schema.",
    "devops": "You are a DevOps specialist. Focus on deployments, system configs, and infrastructure scripts.",
    "architecture": "You are an architecture specialist. Review structural designs and dependencies.",
    "testing": "You are a testing specialist. Propose unit tests, integration tests, or evaluate coverage."
}
...
class DevelopmentSupervisor:
    ...
    def _execute_specialist(self, role: str, task: str, context: str) -> SpecialistResponse | dict:
        prompt = DEVELOPMENT_PROMPTS.get(role, DEVELOPMENT_PROMPTS["coding"]) + "\n" + JSON_INSTRUCTION
        messages = [
