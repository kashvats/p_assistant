...
PERSONAL_PROMPTS = {
    "calendar": "You are a calendar specialist. Manage schedules, conflicts, and events.",
    "tasks": "You are a task specialist. Organize todos, priorities, and routine tracking.",
    "memory": "You are a memory specialist. Analyze past interactions, preferences, and personal context."
}
...
class PersonalSupervisor:
    ...
    def _execute_specialist(self, role: str, task: str, context: str) -> SpecialistResponse | dict:
        prompt = PERSONAL_PROMPTS.get(role, PERSONAL_PROMPTS["memory"]) + "\n" + JSON_INSTRUCTION
        messages = [
